    ...
    <div className={`min-h-screen w-full overflow-x-hidden transition-colors duration-300 ${isDarkMode ? 'bg-gray-900' : 'bg-white'} ${isRTL ? 'rtl' : 'ltr'}`} dir={isRTL ? 'rtl' : 'ltr'}>
     ...
     {/* Hero Section */}
      <section className="w-full h-screen flex flex-col items-center justify-center px-4 sm:px-6 md:px-8 lg:px-16 relative overflow-hidden max-w-full">
        ...
        <div className="relative z-10 max-w-4xl w-full pt-20 text-center"> 
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white mb-6 sm:mb-8 leading-tight" data-aos="fade-up">
            {translate('roadHeroTitle')} <span className='text-[#FF4D00]'>{translate('roadHeroTitleHighlight')}</span>
          </h1>
      ...
      <section className={`w-full text-justify py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 transition-colors duration-300 ${isDarkMode ? 'bg-black' : 'bg-white'}`} data-aos="fade-up" data-aos-duration="1000" data-aos-once="false">
        <div className="max-w-7xl mx-auto w-full overflow-hidden">
          <div className={`mb-16 ${isRTL ? 'text-right' : 'text-center'}`} data-aos="fade-up" data-aos-delay="200" data-aos-once="false">
            <h2 className={`text-3xl sm:text-4xl md:text-5xl font-bold mb-4 ${isDarkMode ? 'text-black' : 'text-gray-800'}`}>{translate('keyBenefits')} <span className='text-[#FF4D00]'></span></h2>
             ...
             <div className="max-w-7xl mx-auto w-full overflow-hidden">
               <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
                 <div className="flex flex-col space-y-8" data-aos="fade-right" data-aos-once="false">
                   <div>
                     <h2 className={`text-3xl sm:text-4xl md:text-5xl font-bold mb-4 ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>{translate('howItWorks')} <span className='text-[#FF4D00]'>{translate('itWorksWord')}</span></h2>
                   ...
                   <div className="pt-4">
                     <button className="bg-[#FF4D00] text-white font-semibold py-3 px-8 rounded-lg hover:bg-[#d32f2f] transition-colors duration-300 transform hover:scale-105">{translate('requestConsultation')}</button>
                   </div>
                 </div>
