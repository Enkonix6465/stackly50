...
const CommercialConstruction = () => {
  ...
  const benefits = [
    translate('turnkeyProjectDelivery'),
    translate('modernSustainableDesigns'),
    translate('strictQualitySafetyStandards'),
    translate('onTimeOnBudgetCompletion'),
    translate('expertProjectManagement'),
    translate('comprehensiveAftercareSupport')
  ];
