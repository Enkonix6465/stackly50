    ...
    <div className="flex flex-col items-center">
      <div className="relative w-full max-w-5xl mx-auto overflow-hidden rounded-2xl shadow-xl">
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent p-6 text-white">
          <h3 className="text-xl sm:text-2xl font-bold mb-2 text-[#FFB380]">{featuredProjects[current].title}</h3>
...
const Home2 = () => {
  ...
  <div className={`relative z-20 flex flex-col pt-20 justify-center ${isRTL ? 'items-end text-right' : 'items-start text-left'}`}>
          ...
          <button className="bg-[#FF4D00] hover:bg-[#e6440a] text-white font-bold py-4 px-8 rounded-xl shadow-lg transform hover:scale-105 transition-all duration-300 animate-fade-in-up text-lg">
          ...
          <div className="max-w-7xl mx-auto">
            <div className={`text-center mb-12 ${isRTL ? 'text-right' : 'text-left'}`}>
              <h2 className="text-4xl md:text-5xl font-bold mb-2">
                <span className="text-black">{translate('meet')} </span>
                <span className="relative inline-block" style={{ color: '#FF4D00' }}>
                  {translate('ourTeam')}
                  <span className="block w-full h-1 rounded-full mt-1" style={{ backgroundColor: '#FF4D00', maxWidth: '120px', margin: '0 auto' }}></span>
                </span>
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              {/* Card 1 */}
              <div className="relative group bg-white rounded-xl shadow-lg overflow-hidden border border-orange-400 transition-transform duration-300 hover:-translate-y-2">
                <img src={trainer1} alt="Michael Stone" className="w-full h-64 object-cover" />
                <div className="absolute inset-0 bg-orange-900 bg-opacity-70 flex flex-col justify-end opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-6">
                  <div>
                    <h3 className="text-white text-xl font-bold mb-1">{translate('michaelStone')}</h3>
                    <p className="text-orange-300 text-sm font-semibold mb-2">{translate('siteManager')}</p>
                    <p className="text-gray-200 text-sm">{translate('michaelStoneDescription')}</p>
                  </div>
                </div>
                <div className="p-6">
                  <h3 className="text-gray-900 text-xl font-bold mb-1">{translate('michaelStone')}</h3>
                  <p className="text-orange-600 text-sm font-semibold">{translate('siteManager')}</p>
                </div>
              </div>
              {/* Card 2 */}
              <div className="relative group bg-white rounded-xl shadow-lg overflow-hidden border border-orange-400 transition-transform duration-300 hover:-translate-y-2">
                <img src={trainer4} alt="Emily Carter" className="w-full h-64 object-cover" />
                <div className="absolute inset-0 bg-orange-900 bg-opacity-70 flex flex-col justify-end opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-6">
                  <div>
                    <h3 className="text-white text-xl font-bold mb-1">{translate('emilyCarter')}</h3>
                    <p className="text-orange-300 text-sm font-semibold mb-2">{translate('projectCoordinator')}</p>
                    <p className="text-gray-200 text-sm">{translate('emilyCarterDescription')}</p>
                  </div>
                </div>
                <div className="p-6">
                  <h3 className="text-gray-900 text-xl font-bold mb-1">{translate('emilyCarter')}</h3>
                  <p className="text-orange-600 text-sm font-semibold">{translate('projectCoordinator')}</p>
                </div>
              </div>
              {/* Card 3 */}
              <div className="relative group bg-white rounded-xl shadow-lg overflow-hidden border border-orange-400 transition-transform duration-300 hover:-translate-y-2">
                <img src={trainer2} alt="David Mason" className="w-full h-64 object-cover" />
                <div className="absolute inset-0 bg-orange-900 bg-opacity-70 flex flex-col justify-end opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-6">
                  <div>
                    <h3 className="text-white text-xl font-bold mb-1">{translate('davidMason')}</h3>
                    <p className="text-orange-300 text-sm font-semibold mb-2">{translate('leadEngineer')}</p>
                    <p className="text-gray-200 text-sm">{translate('davidMasonDescription')}</p>
                  </div>
                </div>
                <div className="p-6">
                  <h3 className="text-gray-900 text-xl font-bold mb-1">{translate('davidMason')}</h3>
                  <p className="text-orange-600 text-sm font-semibold">{translate('leadEngineer')}</p>
                </div>
              </div>
              {/* Card 4 */}
              <div className="relative group bg-white rounded-xl shadow-lg overflow-hidden border border-orange-400 transition-transform duration-300 hover:-translate-y-2">
                <img src={trainer3} alt="Sophia Turner" className="w-full h-64 object-cover" />
                <div className="absolute inset-0 bg-orange-900 bg-opacity-70 flex flex-col justify-end opacity-0 group-hover:opacity-100 transition-opacity duration-300 p-6">
                  <div>
                    <h3 className="text-white text-xl font-bold mb-1">{translate('sophiaTurner')}</h3>
                    <p className="text-orange-300 text-sm font-semibold mb-2">{translate('safetyOfficer')}</p>
                    <p className="text-gray-200 text-sm">{translate('sophiaTurnerDescription')}</p>
                  </div>
                </div>
                <div className="p-6">
                  <h3 className="text-gray-900 text-xl font-bold mb-1">{translate('sophiaTurner')}</h3>
                  <p className="text-orange-600 text-sm font-semibold">{translate('safetyOfficer')}</p>
                </div>
              </div>
            </div>
          </div>
                ...
                <section className="w-full relative min-h-screen">
                  ...
                  <div className="absolute inset-0">
                    ...
                    {/* Light orange gradient overlay from left to center - responsive */}
                    <div className="absolute inset-0 bg-gradient-to-r from-[#FFEDD5] via-[#FFB380]/70 sm:via-[#FFB380]/50 to-transparent"></div>
                  </div>
                  ...
                  <div className="relative z-10 text-justify flex items-center min-h-screen px-4 sm:px-6 md:px-8 lg:px-16 py-12">
                    <div className={`text-white max-w-md sm:max-w-lg md:max-w-xl lg:max-w-md bg-black/20 sm:bg-transparent backdrop-blur-sm sm:backdrop-blur-none rounded-lg sm:rounded-none p-6 sm:p-0 ${isRTL ? 'text-right' : 'text-left'}`}>
                       <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6 animate-fade-in-up" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                         {translate('meet')} <span style={{ color: '#FF4D00' }}>{translate('ourCEO')}</span>
                       </h2>
                       <p className="text-base sm:text-lg md:text-xl mb-4 sm:mb-6 leading-relaxed animate-fade-in-up" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400" style={{ color: '#FF4D00' }}>
                         {translate('ceoMissionStatement')}
                       </p>
                       ...
                       {/* CEO Name */}
                       <p className="text-base sm:text-lg md:text-xl font-semibold mb-6 sm:mb-8 opacity-95 animate-fade-in-up" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="1000" style={{ color: '#FF4D00' }}>
                         - {translate('ceoName')}
                       </p>
            ...
            <section className="w-full py-12 sm:py-16 px-4 sm:px-6 lg:px-8 bg-white transition-colors duration-300">
              <div className="max-w-7xl mx-auto flex flex-col gap-8 sm:gap-10">
                ...
                <div className={`text-center mb-6 sm:mb-8 ${isRTL ? 'text-right' : 'text-left'}`} data-aos="fade-up" data-aos-duration="800">
                  <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 text-[#FF4D00]">{translate('whyBuildersTrustUs')}</h2>
                  <p className="max-w-2xl mx-auto text-sm sm:text-base text-gray-700">{translate('whyBuildersTrustUsDescription')}</p>
                </div>
                {/* Main content grid: image and construction highlights */}
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 items-stretch min-h-[250px] sm:min-h-[300px]">
                  ...
                  <div className="flex flex-col justify-center h-full" data-aos="fade-right" data-aos-duration="800" data-aos-delay="200">
                    <img src={why1} alt="Construction Site" className="rounded-xl w-full h-full min-h-[300px] object-cover" />
                  </div>
                  ...
                  <div className={`flex flex-col gap-4 sm:gap-6 justify-center h-full min-h-[250px] sm:min-h-[300px] ${isRTL ? 'text-right' : 'text-left'}`} data-aos="fade-left" data-aos-duration="800" data-aos-delay="400">
                    <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-[#FF4D00] m-0 p-0">{translate('constructionAdvantages')}</h3>
                    <ul className={`${isRTL ? 'list-none pr-5' : 'list-disc pl-5'} text-gray-800 text-sm sm:text-base md:text-lg space-y-3`}>
                      <li><span className="font-semibold text-[#FF4D00]">{translate('experiencedTeam')}:</span> {translate('experiencedTeamDescription')}</li>
                      <li><span className="font-semibold text-[#FF4D00]">{translate('qualityMaterials')}:</span> {translate('qualityMaterialsDescription')}</li>
                      <li><span className="font-semibold text-[#FF4D00]">{translate('safetyFirst')}:</span> {translate('safetyFirstDescription')}</li>
                      <li><span className="font-semibold text-[#FF4D00]">{translate('onTimeDelivery')}:</span> {translate('onTimeDeliveryDescription')}</li>
                      <li><span className="font-semibold text-[#FF4D00]">{translate('modernEquipment')}:</span> {translate('modernEquipmentDescription')}</li>
                      <li><span className="font-semibold text-[#FF4D00]">{translate('transparentCommunication')}:</span> {translate('transparentCommunicationDescription')}</li>
                    </ul>
                  </div>
                </div>
              </div>
      ...
      <section className="w-full py-12 sm:py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-[#FFEDD5] via-[#FFB380]/40 to-white">
        <div className="max-w-7xl mx-auto">
          <h2 className={`text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-8 sm:mb-12 text-[#FF4D00] ${isRTL ? 'text-right' : 'text-left'}`}>{translate('featuredProjects')}</h2>
      ...
      <section className="w-full py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-[#FFEDD5] via-[#FFB380]/40 to-white text-center">
        <div className={`max-w-3xl mx-auto flex flex-col items-center gap-8 ${isRTL ? 'text-right' : 'text-left'}`}>
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#FF4D00] mb-4">{translate('readyToBuildDream')}</h2>
          <p className="text-lg sm:text-xl text-gray-700 mb-6">{translate('readyToBuildDreamDescription')}</p>
          <a href="#contact" className="inline-block bg-[#FF4D00] text-white font-semibold px-10 py-4 rounded-xl shadow-lg hover:bg-orange-700 transition text-lg">{translate('startYourProject')}</a>
        </div>
      </section>
